...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.openOrders.index')->with('order',$order)->with('users',$users)->with('statuses',$statuses);
    }
       ...
       public function create()
    {
        ...
        return view('admin.openOrders.create')->with('users',$users)->with('materials',$materials);
    }
    ...
    public function edit($locale,$id)
    {
        ...
        $materials=Materials::where('visible',1)->get();
        return view('admin.openOrders.edit')->with('order',$order)->with('status',$status)->with('items',$item)->with('materialsAll',$materials);
    }
    ...
    public function filter(Request $request)
    {
        $url = url()->current();
        $query=$request->query();
        unset($query['submit']); //pravdepodobne všetky 3 príkazy su zbytočné, treba odtestovať.
        ...
        return view('admin.openOrders.filtered')->with('order',$query)->with('users',$users)->with('statuses',$statuses)->with('request',$request)->with('nameOfUser',$nameOfUser);
    }
    ...
    public function select(Request $request)
    {
        ...
        return view('admin.openOrders.select')->with('order',$order)->with('statuses',$statuses);
    }
