...
class ClosedOrdersControllerEmployee extends Controller
{
    ...
    public function index()
    {
        ...
        $statuses=Status::all();
        return view('employee.closedOrders.index')->with('order', $order)->with('users',$users)->with('statuses',$statuses);
    }
    ...
    public function filter(Request $request)
    {
        ...
        return view('employee.closedOrders.filtered')->with('order',$query)->with('users',$users)->with('statuses',$statuses)->with('request',$request)->with('nameOfUser',$nameOfUser);
    }
