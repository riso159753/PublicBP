        ...
        <ul class="app-breadcrumb breadcrumb">
            <div class="dropdown ahref">
                ...
                <div class="dropdown-menu dropdown-menu-right filter mt-5 mt-md-0">
                    <form action="{{ route('employee.openOrders.filter', app()->getLocale()) }}" method="get" role="form" class="px-4 py-3">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status" name="status">
                                <option @if( ! empty($request->status)) value="{{$request->status}}"  @endif >{{--ak je nastaveny filter, tak sa nastavi value --}}
                                    ...
                                    {{$statuses[$request->status-1]->nazov}}
                                    @endif
                                </option>
                        ...
                        <a id="drpClose" href="{{ route('employee.openOrders.index' , app()->getLocale()) }}" class="btn btn-secondary">{{ __('Cancel')}}</a>

                    </form>
                </div>
            </div>
            <a href="{{ route('employee.export_excel.exportActives', app()->getLocale()) }}" class="btn btn-primary ml-2 ml-md-2"> <i class="fa fa-fw fa-lg fa-file-excel-o"></i>{{ __('Excel') }}</a>
        ...
        <div class="col-md-12 col-sm-12">
            <div class="tile">
                ...
                <div class="table-responsive">
                    <form action="{{ route('employee.openOrders.select', app()->getLocale()) }}" method="POST" role="form">
                        @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group d-flex justify-content-center" role="group" aria-label="First group">
                                                ...
                                                <a href="{{route('employee.openOrders.nextStatus', ['id'=> $row->id,'locale'=>app()->getLocale()]) }}" class="btn btn-sm btn-info "><i class="fa fa-level-up"></i></a>
                                                <a href="{{route('employee.openOrders.edit', ['id'=> $row->id,'locale'=>app()->getLocale()]) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                            </div>
                                        </td>
                                    </tr>
