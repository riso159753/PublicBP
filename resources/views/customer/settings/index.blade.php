...
@section('content')
    ...
    <div class="row d-flex justify-content-center ">
        <div class="col-md-5 col-sm-5">
            <div class="tile">
                <form action="{{ route('customer.settings.updateInfo', app()->getLocale()) }}" method="POST" role="form">
                    @csrf
                        ...
                        <div class="tile-footer">
                            <div class="row d-print-none mt-2">
                                <div class="col-12 text-right">
                                    ...
                                    <a class="btn btn-danger" href="{{ route('customer.settings.index', app()->getLocale()) }}"><i class="fa fa-times-circle"></i>{{ __('Cancel') }}</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-md-5 col-sm-5">
            <div class="tile">
                ...
                @endif
                <form action="{{ route('customer.settings.updatePass', app()->getLocale()) }}" method="POST" role="form">
                    @csrf
