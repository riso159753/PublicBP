...
@section('content')
    <div class="app-title">
        ...
        <div class="dropdown-menu dropdown-menu-right filter mt-5 mt-md-0">
            <form action="{{ route('admin.materials.save', app()->getLocale()) }}" method="post" role="form" class="px-4 py-3">
                @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group d-flex justify-content-end" role="group" aria-label="First group">
                                        <a href="{{ route('admin.materials.delete', ['id'=>$row->id,'locale'=>app()->getLocale()]) }}" class="btn btn-sm btn-danger @if((app()->getLocale())=='en') delete-confirm @elseif((app()->getLocale())=='sk') delete-confirmSK @endif"><i class="fa fa-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
