...
@section('content')
    ...
    <div class="col-md-12">
        <form action="{{ route('admin.openOrders.save', app()->getLocale()) }}" method="POST" role="form">
            @csrf
                            ...
                            <div class="tile-footer">
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right">
                                        ...
                                        <a class="btn btn-danger" href="{{ route('admin.openOrders.index', app()->getLocale()) }}"><i class="fa fa-fw fa-lg fa-arrow-left"></i>{{ __('Go Back') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
